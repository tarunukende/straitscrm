        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="row" style="margin-top: 10px">
                    <div class="col-md-4 clo-sm-12" >
                        <label>Date</label><br>
                        <label><?php echo date('d M Y h:i a', strtotime($Record['created_at'])) ?></label>
                    </div>
        ...
        <div class="box">
            ...
            <div class="box-body">
                <form class="form-horizontal form-label-left" id="demo-form2" data-parsley-validate method="post"  enctype="multipart/form-data">
                    ...
                    <!-- <input type="hidden" name="id_check" value="<?php echo $saleslead['id'] ?>"> -->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            <a href="<?php echo base_url() . 'sales_exc/viewlist' ?>"><button class="btn btn-primary" type="button">Cancel</button></a>
