			...
			<div class="box">
				<div class="box-header with-border">
					...
					<div class="pull-right">
						<a class="btn btn-primary" href="<?php echo base_url().'sales_status/add' ?>"> <i class="fa fa-plus"></i> Add</a>
					</div>
				</div>
				<div class="box-body">
								...
								<?php foreach ($Records as $Record): ?>
									<tr>
										...
										<td class="text-center">
											<a href="<?php echo base_url()."sales_status/edit/".$Record['id'] ?>" data-toggle="tooltip" data-placement="top" title="Edit">
		...
		$(document).ready(function()
		{
			...
			$('.delete').click(function()
			{
				...
				if (confirm("Do you want to delete this Record?")==true)
					window.location = url+"sales_status/delete/"+id;
				else
					return false;
			})
			...
			$('.enable').click(function()
			{
				...
				if (confirm("Do you want to enable this Record?")==true)
					window.location = url+"sales_status/enable/"+id;
				else
					return false;
			})
			...
			$('.disable').click(function()
			{
				...
				if (confirm("Do you want to disable this Record?")==true)
					window.location = url+"sales_status/disable/"+id;
				else
					return false;
			})
		});
