			...
			<div class="box">
				<div class="box-header with-border">
					...
					<div class="pull-right">
						<a class="btn btn-primary" href="<?php echo base_url().'sales/add' ?>"> <i class="fa fa-plus"></i> Add</a>
					</div>
				</div>
				<div class="box-body">
						...
						<tbody>
							<?php if ($Records): ?>
								<?php foreach ($Records as $Record): ?>
									<?php $Region = $this->data_model->getById('regions', $Record['region_id']) ?>
									<tr>
										...
										<td>
											<?php if ($Record['region_id']==0): ?>
												<?php  echo('No Region');?>
												<?php else: ?>
													<?php $rg = $this->data_model->getRegionById('regions', $Record['region_id']); ?>
													
													<?php $count=0; foreach ($rg as $value): ?>
														<?php if ($count==0): ?>
															<?php else: ?>
																<?php echo(",") ?>
														<?php endif ?>
										...
										<td class="text-center">
											<a href="<?php echo base_url()."sales/edit/".$Record['id'] ?>" data-toggle="tooltip" data-placement="top" title="Edit">
		...
		$(document).ready(function()
		{
			...
			$('.delete').click(function()
			{
				...
				if (confirm("Do you want to delete this Record?")==true)
					window.location = url+"sales/delete/"+id;
				else
					return false;
			})
			...
			$('.enable').click(function()
			{
				...
				if (confirm("Do you want to enable this Record?")==true)
					window.location = url+"sales/enable/"+id;
				else
					return false;
			})
			...
			$('.disable').click(function()
			{
				...
				if (confirm("Do you want to disable this Record?")==true)
					window.location = url+"sales/disable/"+id;
				else
					return false;
			})
		});
