					...
					<form class="form-horizontal form-label-left" id="demo-form2" data-parsley-validate method="post">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-1">
								<select class="form-control col-md-7 col-xs-12" id="Client_Id" name="status" required="required">
									<option value="1" <?php if($Record['status']==1) echo "selected" ?>>Enabled</option>
									<option value="0" <?php if($Record['status']==0 )echo "selected" ?>>Disabled</option>
								</select>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
								<a href="<?php echo base_url().'publisher' ?>"><button class="btn btn-primary" type="button">Cancel</button></a>
