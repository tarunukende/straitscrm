			...
			<div class="box">
				<div class="box-header with-border">
					...
					<div class="pull-right">
						<a class="btn btn-primary" href="<?php echo base_url().'marketing/add' ?>"> <i class="fa fa-plus"></i> Add</a>
					</div>
				</div>
				<div class="box-body">
						...
						<tbody>
							<?php if ($Records): ?>
								<?php foreach ($Records as $Record): ?>
									<?php $Region = $this->Marketing_model->getById('regions', $Record['region_id']) ?>
									<tr>
										<td><?php echo $Record['id'] ?></td>
										<td><?php echo $Record['name'] ?></td>
										<td><?php echo $Record['email'] ?></td>
										<td><?php echo $Record['mobile_number'] ?></td>
										<td><?php echo ($this->Marketing_model->getById('regions', $Record['region_id'])) ? $Region['name'] : 'No Region' ?></td>
										<!-- <td><?php echo $Record['status'] ?></td> -->
										<td><?php echo ($Record['status']) ? 'Enabled' : 'Disabled' ; ?></td>
										<td class="text-center">
											<a href="<?php echo base_url()."marketing/edit/".$Record['id'] ?>" data-toggle="tooltip" data-placement="top" title="Edit">
		...
		$(document).ready(function()
		{
			...
			$('.delete').click(function()
			{
				...
				if (confirm("Do you want to delete this Record?")==true)
					window.location = url+"marketing/delete/"+id;
				else
					return false;
			})
			...
			$('.enable').click(function()
			{
				...
				if (confirm("Do you want to enable this Record?")==true)
					window.location = url+"marketing/enable/"+id;
				else
					return false;
			})
			...
			$('.disable').click(function()
			{
				...
				if (confirm("Do you want to disable this Record?")==true)
					window.location = url+"marketing/disable/"+id;
				else
					return false;
			})
		});
